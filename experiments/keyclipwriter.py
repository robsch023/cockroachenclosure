"""
Class to contain necessary functions to write video clips to file based instructinon from event identifier script. 
Used in recording.py for buffered event recording..
